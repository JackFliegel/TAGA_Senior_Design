...
const val CCCD_DESCRIPTOR_UUID = "00002902-0000-1000-8000-00805F9B34FB" //Will have to check this value if it has the same GATT table for characterstics wanting to use
